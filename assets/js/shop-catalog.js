...
(function () {
  ...
  const CATALOG = [
    ...
    { sku: "astrahus",                  name: "Astrahus",                  category: "structures", sub: "citadel",            price:             0 },
    { sku: "raitaru",                   name: "Raitaru",                   category: "structures", sub: "engineering",        price:             0 },
    { sku: "athanor",                   name: "Athanor",                   category: "structures", sub: "refinery",           price:             0 },
    { sku: "carbon-polymers",           name: "Carbon Polymers",           category: "materials",  sub: "reaction",  price:             0 },
    { sku: "ceramic-fibers",            name: "Ceramic Fibers",            category: "materials",  sub: "reaction",  price:             0 },
    { sku: "fermionic-condensates",     name: "Fermionic Condensates",     category: "materials",  sub: "reaction",  price:             0 },
    { sku: "fluxed-condensates",        name: "Fluxed Condensates",        category: "materials",  sub: "reaction",  price:             0 },
    { sku: "hypersynaptic-fibers",      name: "Hypersynaptic Fibers",      category: "materials",  sub: "reaction",  price:             0 },
    { sku: "metallofullerene-plating",  name: "Metallofullerene Plating",  category: "materials",  sub: "reaction",  price:             0 },
    { sku: "nanotransistors",           name: "Nanotransistors",           category: "materials",  sub: "reaction",  price:             0 },
    { sku: "nonlinear-metamaterials",   name: "Nonlinear Metamaterials",   category: "materials",  sub: "reaction",  price:             0 },
    { sku: "photonic-metamaterials",    name: "Photonic Metamaterials",    category: "materials",  sub: "reaction",  price:             0 },
    { sku: "plasmonic-metamaterials",   name: "Plasmonic Metamaterials",   category: "materials",  sub: "reaction",  price:             0 },
    { sku: "terahertz-metamaterials",   name: "Terahertz Metamaterials",   category: "materials",  sub: "reaction",  price:             0 },
    ...
    { sku: "nano-factory",                name: "Nano-Factory",                category: "materials",  sub: "planetary", price:             0 },
    { sku: "organic-mortar-applicators",  name: "Organic Mortar Applicators",  category: "materials",  sub: "planetary", price:             0 },
    { sku: "recursive-computing-module",  name: "Recursive Computing Module",  category: "materials",  sub: "planetary", price:             0 },
    { sku: "self-harmonizing-power-core", name: "Self-Harmonizing Power Core", category: "materials",  sub: "planetary", price:             0 },
